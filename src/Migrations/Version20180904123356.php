 ...
 */
final class Version20180904123356 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE card (id INT AUTO_INCREMENT NOT NULL, image_id INT DEFAULT NULL, name VARCHAR(40) NOT NULL, atk INT NOT NULL, def INT NOT NULL, type VARCHAR(20) NOT NULL, prix INT NOT NULL, quantity INT NOT NULL, UNIQUE INDEX UNIQ_161498D33DA5256D (image_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
