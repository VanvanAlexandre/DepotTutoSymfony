 ...
 */
final class Version20180903123334 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE panier CHANGE user_id_id user_id INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE panier CHANGE user_id user_id_id INT NOT NULL');
